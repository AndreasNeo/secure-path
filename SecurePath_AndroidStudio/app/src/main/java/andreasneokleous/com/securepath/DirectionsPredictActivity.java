...
public class DirectionsPredictActivity extends FragmentActivity implements DialogInterface.OnDismissListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, OnMapReadyCallback, RoutingListener, LocationListener {

    private static final LatLng GUILDFORD = new LatLng(51.236134, -0.570950);

    // Calculated from linear regression
    private static final double INTERCEPT = 237.841752;
    private static final double SLOPE = -0.13313892;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_predict_directions_);
        // Map
        ...
        pDialog.setTitle("Predicting Safest Route...");
    ...
    private void buildRoutes() {
        ...
        if (origin == null && destination == null) {
            Toast.makeText(DirectionsPredictActivity.this, "Please enter origin and destination", Toast.LENGTH_SHORT).show();
        }
        if (origin == null) {
            Toast.makeText(DirectionsPredictActivity.this, "Please enter origin location", Toast.LENGTH_SHORT).show();
        }
        if (destination == null) {
            Toast.makeText(DirectionsPredictActivity.this, "Please enter destination", Toast.LENGTH_SHORT).show();
        }
        ...
        if (origin != null && destination != null) {
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .withListener(DirectionsPredictActivity.this)
    ...
    public void onRoutingSuccess(ArrayList<com.directions.route.Route> routes, int shortestRouteIndex) {
        ...
        if (routes.size() == 0) {
            ...
            for (int i = 0; i < routes.size(); i++) {
                ...
                float minDistance =  Collections.min(results);
                ...
                Double crime_count_prediction = INTERCEPT + SLOPE*minDistance;
                int count=0;
                if (crime_count_prediction<0){
                    count = 0;
                }else{
                    count = crime_count_prediction.intValue();
                }
                MyRoute myRoute = new MyRoute(routes.get(i),count,0);
                PolyMyRoutes.put(polyline, myRoute);
                Log.v("CityCenter", String.valueOf(" Crime Prediction " + routes.get(i).getDistanceValue() + " is: " +crime_count_prediction + " , "+count));
                pDialog.dismiss();
            }
        }
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        //  Forloop to find safest route based on Crime Count
        ...
        if (safestPolyMyRoute != null) {
            ...
            RouteInfo_ListAdapter recommendedAdapter = new RouteInfo_ListAdapter(DirectionsPredictActivity.this, safestRouteList,false);
            ...
            RouteInfo_ListAdapter otherAdapter = new RouteInfo_ListAdapter(DirectionsPredictActivity.this, otherRouteList,false);
    ...
    private void animateToMyLocation() {
        ...
        if (location != null) {
            ...
            Toast.makeText(DirectionsPredictActivity.this, "Please enable location services", Toast.LENGTH_SHORT).show();
        }
    }
